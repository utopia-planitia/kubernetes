...
@test "check google-public-dns-a-google-com ip" {
  until [ $(kubectl get pod --selector=job-name=google-public-dns-a-google-com --no-headers | grep Completed | wc -l) -eq 1 ]; do
    sleep 0.5
  done
...
@test "check node-local-dns ip" {
  until [ $(kubectl get pod --selector=job-name=node-local-dns-ip --no-headers | grep Completed | wc -l) -eq 1 ]; do
    sleep 0.5
  done
...
@test "check kubernetes-default-svc-cluster-local ip" {
  until [ $(kubectl get pod --selector=job-name=kubernetes-default-svc-cluster-local --no-headers | grep Completed | wc -l) -eq 1 ]; do
    sleep 0.5
  done
...
@test "check kubernetes-default-svc ip" {
  until [ $(kubectl get pod --selector=job-name=kubernetes-default-svc --no-headers | grep Completed | wc -l) -eq 1 ]; do
    sleep 0.5
  done
...
@test "check kubernetes-default ip" {
  until [ $(kubectl get pod --selector=job-name=kubernetes-default --no-headers | grep Completed | wc -l) -eq 1 ]; do
    sleep 0.5
  done
...
@test "check kubernetes ip" {
  until [ $(kubectl get pod --selector=job-name=kubernetes --no-headers | grep Completed | wc -l) -eq 1 ]; do
    sleep 0.5
  done
