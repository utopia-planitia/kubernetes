...
ovh-provision: ##@ovh start vms and create inventory
	$(CLI) touch inventory
	$(CLI) ansible-playbook ovh-provision.yml -e "region_name=$(OVH_REGION_NAME) OVH_NODES_PREFIX=$(CURRENT_GIT_BRANCH) OVH_KEYPAIR_NAME=$(OVH_KEYPAIR_NAME)" ${ANSIBLE_OPTIONS}
